...
const MODE_REGISTER = "Restaurant Register";
const MODE_LOGIN = "Restaurant Login";


// componenet to handle login of an existing user or registration of a new one
function RestLoginOrRegister({setCount, count}) {
...
// renders the login or register page
    return (
        <div state={formState.logState}>
            ...
            <button onClick={switchUserType} name="changeAppPage"><h3>Switch to Driver UI</h3></button>
        </div>
